<!-- resource_dir: /Users/seonjunkim/.dotfiles/config/agents/skills/l4l/agent-skills/experiment-planner -->

> **Note for slash command use**: Supporting resource files for this skill
> are located at `/Users/seonjunkim/.dotfiles/config/agents/skills/l4l/agent-skills/experiment-planner/`. When this skill instructs you to load a
